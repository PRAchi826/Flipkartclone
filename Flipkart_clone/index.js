let arr = [
    {
      ...
      title: "<input type='button' value='Grocery' onclick='redirect();'>",
    },
    {
      img_src:
        "https://rukminim1.flixcart.com/flap/80/80/image/22fddf3c7da4c4f4.png?q=100",
      title: "<input type='button' value='Mobiles' onclick='redirect();'>",
    },
    {
      img_src:
        "https://rukminim1.flixcart.com/fk-p-flap/128/128/image/0d75b34f7d8fbcb3.png?q=100",
      title:"<input type='button' value='Fashion' onclick='redirect();'>",
